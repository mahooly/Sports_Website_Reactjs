...
store.dispatch(addArticle(
    {
        description: 'جیمز در رویارویی لیکرز با هیت، بهتر از وید ظاهر شد',
        title: 'رویارویی لبران جیمز و دواین وید',
        image: 'https://images.beinsports.com/paNSbZ6ypTbZG-r6qNw7LUW4TdA=/full-fit-in/1000x0/lebronwade-cropped_1h1gw3jfqyvz31dseekts5tuc8.jpg',
        date: moment('2018-12-12').valueOf(),
        tags: ['لبران جیمز', 'دواین وید', 'لس آنجلس لیکرز', 'میامی هیت'],
